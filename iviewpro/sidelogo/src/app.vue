...
<style lang='less'>
    ...
    .root .content{
        ...
        //.content > .ivu-tabs.ivu-tabs-card > .ivu-tabs-bar .ivu-tabs-tab .ivu-icon-ios-close-empty
        .mytab{
            >.ivu-tabs-bar{margin-bottom: 0;background: #fff;}
            >.ivu-tabs-content{overflow: hidden;;overflow-y: auto;
                position:relative;
            }
            >.ivu-tabs-bar .ivu-tabs-tab{
                background: transparent; color: #7e7f80;
            }
            ...
            >.ivu-tabs-bar .ivu-tabs-tab .ivu-icon-ios-close-empty{
                color: #2D8CF0;
            }
